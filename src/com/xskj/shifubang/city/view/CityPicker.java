package com.xskj.shifubang.city.view;
...
import com.xskj.shifubang.city.view.ScrollerNumberPicker.OnSelectListener;
...
public class CityPicker extends LinearLayout {
	...
	protected void onFinishInflate() {
		...
		LayoutInflater.from(getContext()).inflate(R.layout.activity_register_picker_city, this);
		...
		provincePicker.setOnSelectListener(new OnSelectListener() {
			...
			public void endSelect(int id, String text) {
				...
				if (tempProvinceIndex != id) {
					...
					city_code_string = CitycodeUtil.getSingleton().getCouny_list_code()
							.get(0);
...
/*		city_string = provincePicker.getSelectedText()
		...
		city_string = counyPicker.getSelectedText(); //获取第三级
		return city_string;
	}
