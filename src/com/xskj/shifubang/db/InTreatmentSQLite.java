...
public class InTreatmentSQLite extends SQLiteOpenHelper {

	private final static String SQL_NAME = "inTreatment_Data.db";
	private final static String TABLE_NAME = "inTreatment_data";
	private final static int VERSION = 2;

	public InTreatmentSQLite(Context context) {
