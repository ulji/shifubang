...
public class AllSQLite extends SQLiteOpenHelper {

	private final static String SQL_NAME = "all_Data.db";
	private final static String TABLE_NAME = "all_data";
	private final static int VERSION = 2;

	public AllSQLite(Context context) {
