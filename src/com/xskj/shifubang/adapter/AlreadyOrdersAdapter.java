...
public class AlreadyOrdersAdapter extends BaseAdapter {

	private List<AllOrdersBeen.T> list;
	private Context context;
	

	public AlreadyOrdersAdapter(List<AllOrdersBeen.T> list, Context context) {
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.orderPrice = (TextView) convertView.findViewById(R.id.tv_orderPrice);
		...
		if ("".equals(servicePrice) || servicePrice == null)
			viewHolder.orderPrice.setText("¥0");
		else
			viewHolder.orderPrice.setText("¥" + servicePrice);
